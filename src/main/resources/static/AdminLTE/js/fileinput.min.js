...
!function (e) {
    ...
    t = {
        ...
        constructor: i, _cleanup: function () {
            ...
            var i, a, r, n, o, l, s, d, c, u, p, f, g, m, v, h, w, b, _, C, y, x, T, P, I, E, k, S, F, A, z, D, M, $, U,
                j, R, O, B, L, Z, N = this;
            i = '{preview}\n<div class="kv-upload-progress kv-hidden"></div><div class="clearfix"></div>\n<div class="input-group {class}">\n  {caption}\n<div class="input-group-btn input-group-append">\n      {remove}\n      {cancel}\n      {pause}\n      {upload}\n      {browse}\n    </div>\n</div>', a = '{preview}\n<div class="kv-upload-progress kv-hidden"></div>\n<div class="clearfix"></div>\n{remove}\n{cancel}\n{upload}\n{browse}\n', r = '<div class="file-preview {class}">\n    {close}    <div class="{dropClass}">\n    <div class="file-preview-thumbnails">\n    </div>\n    <div class="clearfix"></div>    <div class="file-preview-status text-center text-success"></div>\n    <div class="kv-fileinput-error"></div>\n    </div>\n</div>', o = t.closeButton("fileinput-remove"), n = '<i class="glyphicon glyphicon-file"></i>', l = '<div class="file-caption form-control {class}" tabindex="500">\n  <span class="file-caption-icon"></span>\n  <input class="file-caption-name" onkeydown="return false;" onpaste="return false;">\n</div>', s = '<button type="{type}" tabindex="500" title="{title}" class="{css}" {status}>{icon} {label}</button>', d = '<a href="{href}" tabindex="500" title="{title}" class="{css}" {status}>{icon} {label}</a>', c = '<div tabindex="500" class="{css}" {status}>{icon} {label}</div>', u = '<div id="' + t.MODAL_ID + '" class="file-zoom-dialog modal fade" tabindex="-1" aria-labelledby="' + t.MODAL_ID + 'Label"></div>', p = '<div class="modal-dialog modal-lg{rtl}" role="document">\n  <div class="modal-content">\n    <div class="modal-header">\n      <h5 class="modal-title">{heading}</h5>\n      <span class="kv-zoom-title"></span>\n      <div class="kv-zoom-actions">{toggleheader}{fullscreen}{borderless}{close}</div>\n    </div>\n    <div class="modal-body">\n      <div class="floating-buttons"></div>\n      <div class="kv-zoom-body file-zoom-content {zoomFrameClass}"></div>\n{prev} {next}\n    </div>\n  </div>\n</div>\n', f = '<div class="progress">\n    <div class="{class}" role="progressbar" aria-valuenow="{percent}" aria-valuemin="0" aria-valuemax="100" style="width:{percent}%;">\n        {status}\n     </div>\n</div>{stats}', Z = '<div class="text-info file-upload-stats"><span class="pending-time">{pendingTime}</span> <span class="upload-speed">{uploadSpeed}</span></div>', g = " <samp>({sizeText})</samp>", m = '<div class="file-thumbnail-footer">\n    <div class="file-footer-caption" title="{caption}">\n        <div class="file-caption-info">{caption}</div>\n        <div class="file-size-info">{size}</div>\n    </div>\n    {progress}\n{indicator}\n{actions}\n</div>', v = '<div class="file-actions">\n    <div class="file-footer-buttons">\n        {download} {upload} {delete} {zoom} {other}    </div>\n</div>\n{drag}\n<div class="clearfix"></div>', h = '<button type="button" class="kv-file-remove {removeClass}" title="{removeTitle}" {dataUrl}{dataKey}>{removeIcon}</button>\n', w = '<button type="button" class="kv-file-upload {uploadClass}" title="{uploadTitle}">{uploadIcon}</button>', b = '<a class="kv-file-download {downloadClass}" title="{downloadTitle}" href="{downloadUrl}" download="{caption}" target="_blank">{downloadIcon}</a>', _ = '<button type="button" class="kv-file-zoom {zoomClass}" title="{zoomTitle}">{zoomIcon}</button>', C = '<span class="file-drag-handle {dragClass}" title="{dragTitle}">{dragIcon}</span>', y = '<div class="file-upload-indicator" title="{indicatorTitle}">{indicator}</div>', x = '<div class="file-preview-frame {frameClass}" id="{previewId}" data-fileindex="{fileindex}" data-fileid="{fileid}" data-template="{template}"', T = x + '><div class="kv-file-content">\n', P = x + ' title="{caption}"><div class="kv-file-content">\n', I = "</div>{footer}\n</div>\n", E = "{content}\n", O = " {style}", k = '<div class="kv-preview-data file-preview-html" title="{caption}"' + O + ">{data}</div>\n", S = '<img src="{data}" class="file-preview-image kv-preview-data" title="{title}" alt="{alt}"' + O + ">\n", F = '<textarea class="kv-preview-data file-preview-text" title="{caption}" readonly' + O + ">{data}</textarea>\n", A = '<iframe class="kv-preview-data file-preview-office" src="https://view.officeapps.live.com/op/embed.aspx?src={data}"' + O + "></iframe>", z = '<iframe class="kv-preview-data file-preview-gdocs" src="https://docs.google.com/gview?url={data}&embedded=true"' + O + "></iframe>", D = '<video class="kv-preview-data file-preview-video" controls' + O + '>\n<source src="{data}" type="{type}">\n' + t.DEFAULT_PREVIEW + "\n</video>\n", M = '<!--suppress ALL --><audio class="kv-preview-data file-preview-audio" controls' + O + '>\n<source src="{data}" type="{type}">\n' + t.DEFAULT_PREVIEW + "\n</audio>\n", $ = '<embed class="kv-preview-data file-preview-flash" src="{data}" type="application/x-shockwave-flash"' + O + ">\n", j = '<embed class="kv-preview-data file-preview-pdf" src="{data}" type="application/pdf"' + O + ">\n", U = '<object class="kv-preview-data file-preview-object file-object {typeCss}" data="{data}" type="{type}"' + O + '>\n<param name="movie" value="{caption}" />\n' + t.OBJECT_PARAMS + " " + t.DEFAULT_PREVIEW + "\n</object>\n", R = '<div class="kv-preview-data file-preview-other-frame"' + O + ">\n" + t.DEFAULT_PREVIEW + "\n</div>\n", B = '<div class="kv-zoom-cache" style="display:none">{zoomContent}</div>', L = {
                ...
                previewMarkupTags: {tagBefore1: T, tagBefore2: P, tagAfter: I},
            ...
            i.previewCache = {
                data: {}, init: function () {
                    ...
                    var n, o, l, s, d, c, u, p, f = "init_" + a, g = i.previewCache.data, m = g.config[a],
                        v = g.content[a], h = i.previewInitId + "-" + f,
                        w = t.ifSet("previewAsData", m, i.initialPreviewAsData),
                        b = m ? {title: m.title || null, alt: m.alt || null} : {title: null, alt: null},
                        _ = function (e, a, r, o, l, s, d, c, u) {
                    ...
                    var o = i.previewCache.data, l = e.length - 1;
            ...
            a && (e = '"' + a + '": ' + e), e = "bootstrap-fileinput: " + e, "object" == typeof t && e.setTokens(t), "undefined" != typeof window.console.log ? window.console.log(e) : window.alert(e)
        }, _validate: function () {
            ...
            t.autoOrientImageInitial && t.getFrames(".file-preview-initial").each(function () {
                ...
                l && l.exif && l.exif.Orientation && (n = o.attr("id"), a = o.find(">.kv-file-content img"), r = t.$preview.find("#zoom-" + n + " >.kv-file-content img"), t.setImageOrientation(a, r, l.exif.Orientation, o)), i++
            })
            ...
            var r, n, o, l, s, d, c, u, p, f, g = this, m = i.attr("id"), v = g.$preview.find("#zoom-" + m),
                h = g.$modal, w = h.find(".btn-fullscreen"), b = h.find(".btn-borderless"),
            ...
            var a = this, r = e("#" + i);
            return r.length ? r : (a._log(t.logMessages.invalidThumb, {id: i}), null)
            ...
            var e, i, a = this, r = a.uploadCache, n = 0, o = a.cacheInitialPreview;
            if (o && o.content && (n = o.content.length), a.showPreview) {
                if (a.previewCache.set(r.content, r.config, r.tags, r.append), n) {
                    for (e = 0; e < r.content.length; e++) i = e + n, o.content[i] = r.content[e], o.config.length && (o.config[i] = r.config[e]), o.tags.length && (o.tags[i] = r.tags[e]);
                ...
                } else a.initialPreview = r.content, a.initialPreviewConfig = r.config,
                    a.initialPreviewThumbTags = r.tags;
            ...
            var n, o, l, s, d, c, u, p, f, g, m, v, h, w = this, b = w.fileManager, _ = b.count(), C = new FormData,
                y = w.previewInitId + "-" + i, x = _ > 0 || !e.isEmptyObject(w.uploadExtraData),
                T = w.ajaxOperations.uploadThumb, P = b.getFile(a), I = {id: y, index: i, fileId: a},
                E = w.fileManager.getFileName(a, !0);
            w.enableResumableUpload || (w.showPreview && (o = w.fileManager.getThumb(a), u = o.find(".file-thumb-progress"), s = o.find(".kv-file-upload"), d = o.find(".kv-file-remove"), u.show()), 0 === _ || !x || w.showPreview && s && s.hasClass("disabled") || w._abort(I) || (h = function () {
                ...
                f = w._parseError(T, t, n, w.fileManager.getFileName(a)), c = !0, setTimeout(function () {
                    r && h(), w.fileManager.setProgress(a, 100), w._setPreviewError(o, !0), w.retryErrorUploads || s.hide(), e.extend(!0, I, w._getOutData(C, t)), w._setProgress(101, u, w.msgAjaxProgressError.replace("{operation}", T)), w._setProgress(101, o.find(".file-thumb-progress"), w.msgUploadError), w._showFileError(f, I)
                }, w.processDelay)
            }, C.append(w.uploadFileAttr, P.file, E), w._setUploadData(C, {fileId: a}), w._ajaxSubmit(p, g, m, v, C, a, i)))
            ...
            i.showPreview && (i._initZoomButton(), i.getFrames(" .kv-file-remove").each(function () {
                var r, n, o, l, s = e(this), d = s.closest(t.FRAMES), c = d.attr("id"), u = d.attr("data-fileindex");
                i._handler(s, "click", function () {
                    return l = i._raise("filepreremove", [c, u]), l !== !1 && i._validateMinCount() ? (r = d.hasClass("file-preview-error"), t.cleanMemory(d), void d.fadeOut("slow", function () {
                        ...
                        var l, s = i.previewCache.count(!0), p = i.fileManager.count(),
            ...
            i._initZoomButton(), a.find(n).each(function () {
                var n, o, c, u, p = e(this), f = p.data("url") || i.deleteUrl, g = p.data("key"),
                    m = i.ajaxOperations.deleteThumb;
                if (!t.isEmpty(f) && void 0 !== g) {
                    "function" == typeof f && (f = f());
                    var v, h, w, b, _, C = p.closest(t.FRAMES), y = i.previewCache.data, x = C.attr("data-fileindex");
                    x = parseInt(x.replace("init_", "")), w = t.isEmpty(y.config) && t.isEmpty(y.config[x]) ? null : y.config[x], _ = t.isEmpty(w) || t.isEmpty(w.extra) ? r : w.extra, b = w.filename || w.caption || "", "function" == typeof _ && (_ = _()), h = {
                        id: p.attr("id"),
                        key: g,
                        extra: _
                    }, o = function (e) {
                        i.ajaxAborted = !1, i._raise("filepredelete", [g, e, _]), i._abort() ? e.abort() : (p.removeClass(s), t.addCss(C, "file-uploading"), t.addCss(p, "disabled " + l))
                    }, c = function (e, r, o) {
                        var c, u;
                        return t.isEmpty(e) || t.isEmpty(e.error) ? (C.removeClass("file-uploading").addClass("file-deleted"), void C.fadeOut("slow", function () {
                            x = parseInt(C.attr("data-fileindex").replace("init_", "")), i.previewCache.unset(x), i._deleteFileIndex(C), c = i.previewCache.count(!0), u = c > 0 ? i._getMsgSelected(c) : "", i._setCaption(u), i._raise("filedeleted", [g, o, _]), t.cleanZoomCache(a.find("#zoom-" + C.attr("id"))), i._clearObjects(C), C.remove(), d()
                        })) : (h.jqXHR = o, h.response = e, n = i._parseError(m, o, i.msgDeleteError, b), i._showFileError(n, h, "filedeleteerror"), C.removeClass("file-uploading"), p.removeClass("disabled " + l).addClass(s), void d())
                    }, u = function (e, t, a) {
                        var r = i._parseError(m, e, a, b);
                        h.jqXHR = e, h.response = {}, i._showFileError(r, h, "filedeleteerror"), C.removeClass("file-uploading"), p.removeClass("disabled " + l).addClass(s), d()
                    }, i._initAjaxSettings(), i._mergeAjaxCallback("beforeSend", o, "delete"), i._mergeAjaxCallback("success", c, "delete"), i._mergeAjaxCallback("error", u, "delete"), v = e.extend(!0, {}, {
                        url: i._encodeURI(f),
                        type: "POST",
                        dataType: "json",
                        data: e.extend(!0, {}, {key: g}, _)
                    }, i._ajaxDeleteSettings), i._handler(p, "click", function () {
                        return i._validateMinCount() ? (i.ajaxAborted = !1, i._raise("filebeforedelete", [g, _]), void (i.ajaxAborted instanceof Promise ? i.ajaxAborted.then(function (t) {
                            t || e.ajax(v)
                        }) : i.ajaxAborted || e.ajax(v))) : !1
                    })
                }
            })
            ...
            var v, h, w, b = this, _ = b.slug(r), C = "", y = "",
                x = window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth,
                T = b.preferIconicPreview ? "other" : i, P = _, I = _, E = u || b._renderFileFooter(i, _, d, "auto", s),
                k = b._getPreviewIcon(r), S = "type-default", F = k && b.preferIconicPreview,
                A = k && b.preferIconicZoomPreview;
            return h = 400 > x ? b.previewSettingsSmall[T] || b.defaults.previewSettingsSmall[T] : b.previewSettings[T] || b.defaults.previewSettings[T], h && e.each(h, function (e, t) {
                ...
                }), t.isEmpty(g) || (void 0 !== g.title && null !== g.title && (P = g.title), void 0 !== g.alt && null !== g.alt && (P = g.alt)), v.setTokens({
                    previewId: m,
                    caption: _,
                    title: P,
                    alt: I,
            ...
            if (n.showPreview) {
                var l, s = t.getFileName(i), d = i ? i.type : "", c = i.size || 0, u = n._getFileName(i, ""),
                    p = r === !0 && !n.isAjaxUpload, f = t.createObjectURL(i), g = n.fileManager.getId(i);
            ...
            if (this.showPreview) {
                var l, s = this, d = t.getFileName(i), c = o.type, u = o.name, p = s._parseFileType(c, d),
                    f = s.$preview, g = i.size || 0,
                    m = "text" === p || "html" === p || "image" === p ? a.target.result : n, v = s.fileManager.getId(i);
                ...
                var h = f.find("#" + r), w = h.find("img"), b = h.attr("data-fileid");
        ...
        }, _validateImageOrientation: function (t, i, a, r, n, o, l, s) {
            var d, c, u = this, p = u.autoOrientImage;
            return d = p ? u._getExifObj(s) : null, (c = d ? d["0th"][piexif.ImageIFD.Orientation] : null) ? (u.setImageOrientation(t, e("#zoom-" + a + " img"), c, e("#" + a)), u._raise("fileimageoriented", {
                $img: t,
                file: i
            }), void u._validateImage(a, r, n, o, l, s, d)) : void u._validateImage(a, r, n, o, l, s, d)
        }, _validateImage: function (t, i, a, r, n, o, l) {
            var s, d, c, u = this, p = u.$preview, f = p.find("#" + t), g = f.attr("data-fileindex"), m = f.find("img");
            ...
            var o, l, s, d, c, u, p, f, g, m, v = this, h = e(a.img)[0], w = h.naturalWidth, b = h.naturalHeight, _ = 1,
                C = v.maxImageWidth || w, y = v.maxImageHeight || b, x = !(!w || !b), T = v.imageCanvas,
                P = v.imageCanvasContext, I = a.typ, E = a.pid, k = a.ind, S = a.thumb, F = a.exifObj;
            if (c = function (e, t, i) {
                v.isAjaxUpload ? v._showFileError(e, t, i) : v._showError(e, t, i), v._setPreviewError(S)
            }, f = v.fileManager.getFile(i), g = {
                id: E,
                index: k,
                fileId: i
            }, m = [i, E, k], (!f || !x || C >= w && y >= b) && (x && f && v._raise("fileimageresized", m), r.val++, r.val === n && v._raise("fileimagesresized"), !x)) return void c(v.msgImageResizeError, g, "fileimageresizeerror");
            I = I || v.resizeDefaultImageType, l = w > C, s = b > y, _ = "width" === v.resizePreference ? l ? C / w : s ? y / b : 1 : s ? y / b : l ? C / w : 1, v._resetCanvas(), w *= _, b *= _, T.width = w, T.height = b;
            try {
                P.drawImage(h, 0, 0, w, b), d = T.toDataURL(I, v.resizeQuality), F && (p = window.piexif.dump(F), d = window.piexif.insert(p, d)), o = t.dataURI2Blob(d), v.fileManager.setFile(i, o), v._raise("fileimageresized", m), r.val++, r.val === n && v._raise("fileimagesresized", [void 0, void 0]), o instanceof Blob || c(v.msgImageResizeError, g, "fileimageresizeerror")
            } catch (A) {
            ...
            })), n && d && (f = "drag-handle-init " + y.dragClass, v = p._getLayoutTemplate("actionDrag").setTokens({
                dragClass: f,
                dragTitle: y.dragTitle,
                dragIcon: y.dragIcon
            })), C.setTokens({"delete": w, upload: b, download: _, zoom: m, drag: v, other: x})
        }, _browse: function (e) {
            var t = this;
            ...
            if (!a.changeTriggered) {
                var r, n, o, l = a.$element, s = arguments.length > 1, d = a.isAjaxUpload,
                    c = s ? arguments[1] : l.get(0).files, u = !d && t.isEmpty(l.attr("multiple")) ? 1 : a.maxFileCount,
                    p = a.fileManager.count(), f = t.isEmpty(l.attr("multiple")), g = f && p > 0,
                    m = function (t, i, r, n) {
                        var o = e.extend(!0, {}, a._getOutData(null, {}, {}, c), {id: r, index: n}),
                            l = {id: r, index: n, file: i, files: c};
                        return d ? a._showFileError(t, o) : a._showError(t, l)
                    }, v = function (e, t) {
                ...
                if (a.reader = null, a._resetUpload(), a._hideFileIcon(), a.dropZoneEnabled && a.$container.find(".file-drop-zone ." + a.dropZoneTitleClass).remove(), d || (c = i.target && void 0 === i.target.files ? i.target.value ? [{name: i.target.value.replace(/^.+\\/, "")}] : [] : i.target.files || {}), r = c, t.isEmpty(r) || 0 === r.length) return d || a.clear(), void a._raise("fileselectnone");
            ...
            i._getThumbs().each(function () {
                var r = e(this), n = r.attr("data-fileindex"), o = r.attr("id");
            ...
            var a, r = this, n = r.$element, o = r.reader, l = r.$previewContainer, s = r.$previewStatus,
                ...
                g = r.fileManager.count(), m = r.allowedFileTypes, v = m ? m.length : 0, h = r.allowedFileExtensions,
                w = t.isEmpty(h) ? "" : h.join(", "), b = function (t, n, o, l, s) {
                    var d = e.extend(!0, {}, r._getOutData(null, {}, {}, i), {id: o, index: l, fileId: s}), c = e("#" + o),
                        u = {id: o, index: l, fileId: s, file: n, files: i};
                    r._previewDefault(n, o, !0), r.isAjaxUpload ? setTimeout(function () {
                        a(l + 1)
                    }, r.processDelay) : p = 0, r._initFileActions(), c.remove(), r.isError = r.isAjaxUpload ? r._showFileError(t, d) : r._showError(t, u), r._updateFileDetails(p)
                };
            r.fileManager.clearImages(), e.each(i, function (e, t) {
                ...
                var C, y, x, T, P, I, E, k, S, F, A, z, D, M, $ = g + _, U = u + "-" + $, j = i[_], R = f.text,
                    O = f.image, B = f.html, L = r._getFileName(j, ""), Z = (j && j.size || 0) / 1e3, N = "",
                    H = t.createObjectURL(j), q = 0, W = "", V = 0, K = function () {
                        var e = c.setTokens({index: _ + 1, files: p, percent: 50, name: L});
                        setTimeout(function () {
                            s.html(e), r._updateFileDetails(p), a(_ + 1)
                        }, r.processDelay), r._raise("fileloaded", [j, U, _, o])
                    };
                if (j) {
                    if (S = r.fileManager.getId(j), v > 0) for (y = 0; v > y; y++) E = m[y], k = r.msgFileTypes[E] || E, W += 0 === y ? k : ", " + k;
                    if (L === !1) return void a(_ + 1);
                    if (0 === L.length) return x = r.msgInvalidFileName.replace("{name}", t.htmlEncode(t.getFileName(j), "[unknown]")), void b(x, j, U, _, S);
                    if (t.isEmpty(h) || (N = new RegExp("\\.(" + h.join("|") + ")$", "i")), C = Z.toFixed(2), r.maxFileSize > 0 && Z > r.maxFileSize) return x = r.msgSizeTooLarge.setTokens({
                        name: L,
                        size: C,
                        maxSize: r.maxFileSize
                    }), void b(x, j, U, _, S);
                    if (null !== r.minFileSize && Z <= t.getNum(r.minFileSize)) return x = r.msgSizeTooSmall.setTokens({
                        name: L,
                        size: C,
                        minSize: r.minFileSize
                    }), void b(x, j, U, _, S);
                    if (!t.isEmpty(m) && t.isArray(m)) {
                        for (y = 0; y < m.length; y += 1) P = m[y], F = f[P], q += F && "function" == typeof F && F(j.type, t.getFileName(j)) ? 1 : 0;
                        if (0 === q) return x = r.msgInvalidFileType.setTokens({
                            name: L,
                            types: W
                        }), void b(x, j, U, _, S)
                    }
                    if (0 === q && !t.isEmpty(h) && t.isArray(h) && !t.isEmpty(N) && (I = t.compare(L, N), q += t.isEmpty(I) ? 0 : I.length, 0 === q)) return x = r.msgInvalidFileExtension.setTokens({
                        name: L,
                        extensions: w
                    }), void b(x, j, U, _, S);
                    if (r.isAjaxUpload && r.fileManager.exists(S)) return x = r.msgDuplicateFile.setTokens({
                        name: L,
                        size: C
                    }), b(x, j, U, _, S), T = e("#" + U), void (T && T.length && T.remove());
                    if (!r.canPreview(j)) return r.isAjaxUpload && r.fileManager.add(j), r.showPreview && (l.addClass("file-thumb-loading"), r._previewDefault(j, U), r._initFileActions()), void setTimeout(function () {
                        r._updateFileDetails(p), a(_ + 1), r._raise("fileloaded", [j, U, _])
                    }, 10);
                    A = R(j.type, L), z = B(j.type, L), D = O(j.type, L), s.html(d.replace("{index}", _ + 1).replace("{files}", p)), l.addClass("file-thumb-loading"), o.onerror = function (e) {
                        r._errorHandler(e, L)
                    }, o.onload = function (i) {
                        var a, n, l, s, d, c, u = [], p = function (e) {
                            ...
                            t.onerror = function (e) {
                                ...
                                r._previewFile(_, j, e, U, H, n), r._initFileActions(), K()
                            }, e ? t.readAsText(j, r.textEncoding) : t.readAsDataURL(j)
                        };
                        if (n = {name: L, type: j.type}, e.each(f, function (e, t) {
                            "object" !== e && "other" !== e && "function" == typeof t && t(j.type, L) && V++
                        }), 0 === V) {
                            for (l = new Uint8Array(i.target.result), y = 0; y < l.length; y++) s = l[y].toString(16), u.push(s);
                            if (a = u.join("").toLowerCase().substring(0, 8), c = t.getMimeType(a, "", ""), t.isEmpty(c) && (d = t.arrayBuffer2String(o.result), c = t.isSvg(d) ? "image/svg+xml" : t.getMimeType(a, d, j.type)), n = {
                                name: L,
                                type: c
                            }, A = R(c, ""), z = B(c, ""), D = O(c, ""), M = A || z, M || D) return void p(M)
                        }
                        r._previewFile(_, j, i, U, H, n), r._initFileActions(), K()
                    }, o.onprogress = function (e) {
                        if (e.lengthComputable) {
                            var t = e.loaded / e.total * 100, i = Math.ceil(t);
                            x = c.setTokens({index: _ + 1, files: p, percent: i, name: L}), setTimeout(function () {
                                s.html(x)
                            }, r.processDelay)
                        }
                    }, A || z ? o.readAsText(j, r.textEncoding) : D ? o.readAsDataURL(j) : o.readAsArrayBuffer(j), r.fileManager.add(j)
                }
            ...
            var i, a, r, n = this, o = n.fileManager, l = o.count(), s = !e.isEmptyObject(n._getExtraData());
            if (n.isAjaxUpload && !n.isDisabled && n._isFileSelectionValid(l)) {
                if (n.lastProgress = 0, n._resetUpload(), 0 === l && !s) return void n._showFileError(n.msgUploadEmpty);
                if (n.cancelling = !1, n.$progress.show(), n.lock(), r = o.count(), 0 === l && s) return n._setProgress(2), void n._uploadExtraOnly();
                if (n.enableResumableUpload) return n.resume();
                if (n.uploadAsync || n.enableResumableUpload) {
                    for (a = n._getOutData(null), n._raise("filebatchpreupload", [a]), n.fileBatchCompleted = !1, n.uploadCache = {
                        ...
                        tags: [],
                        append: !0
                    }, i = 0; r > i; i++) n.uploadCache.content[i] = null, n.uploadCache.config[i] = null, n.uploadCache.tags[i] = null;
